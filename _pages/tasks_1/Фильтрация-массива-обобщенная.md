---
replit: https://repl.it/@IlyaSiganov/filtergeneral#main.c
tag: выделение памяти, массивы, строки, указ_на_функцию, указатели
---

# Обобщенная фильтрация массива

![картинка](/images/filter.jpg)

Реализовать функцию filter из [Фильтрация массива](Фильтрация-массива.md) так, чтобы она работала с произвольными типами. За выполнение этого задания будут начислены бонусы.
